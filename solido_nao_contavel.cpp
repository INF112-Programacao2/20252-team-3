...
SolidoNaoContavel::SolidoNaoContavel() {}
SolidoNaoContavel::SolidoNaoContavel(int id, std::string categoria, std::string nome, std::string subclasse_tipo):
...
double SolidoNaoContavel::getQuantidadeGramas() {
	if (_unidadeMedida != "") {
...
void SolidoNaoContavel::converterQuantidadeParaGramas() {
    ...
    std::cout << "\nNao é possivel converter volume (mL) para massa (gramas) sem saber a densidade do solido.\n";
    while (true) {
